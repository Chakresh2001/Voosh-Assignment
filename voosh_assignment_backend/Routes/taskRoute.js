...
taskRoute.patch("/edit/:taskId", authenticateToken, checkTaskOwnership, async (req, res) => {
...
taskRoute.delete("/delete/:taskId", authenticateToken, checkTaskOwnership, async (req, res) => {
    const { taskId } = req.params;
